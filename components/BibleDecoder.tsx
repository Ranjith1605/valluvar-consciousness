    ...
    <div className="mt-8 relative group">
      ...
      <div className="relative p-8 rounded-xl bg-charcoal-light border border-gold/10 backdrop-blur-sm overflow-hidden">
        ...
        <div className="grid md:grid-cols-2 gap-12 relative">
          ...
          <div className="hidden md:flex absolute left-1/2 top-0 bottom-0 w-px bg-gradient-to-b from-transparent via-gold/30 to-transparent -translate-x-1/2 justify-center items-center">
            <motion.div
              ...
              className="w-8 h-8 rounded-full bg-charcoal border border-gold/30 flex items-center justify-center z-10 shadow-[0_0_10px_rgba(255,215,0,0.2)]"
            >
          ...
          >
            ...
            <h4 className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-3 pl-1">Ancient Logic (Kural)</h4>
          ...
          >
            ...
            <h4 className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-3 pl-1">Universal Filter ({kural.bibleVerse.verse})</h4>
        ...
        <div className="mt-8 flex items-center gap-4">
          ...
          <span className="text-[10px] font-mono text-gold uppercase tracking-tighter">Wisdom Sync: 100% Verified</span>
        </div>
